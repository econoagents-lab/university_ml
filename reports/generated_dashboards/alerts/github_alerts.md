...
**Familia:** `alerts`  
**Owner:** MLOps  
**Audiencia:** Product Owner  
**Prioridad:** governance  
**Estado:** cataloged

## Pregunta económica

¿Qué alertas se activaron y por qué?
...
`config/alert_thresholds.yml#github_actions`

## Parámetros actuales usados como contexto

```yaml
create_issue_on_critical: true
create_issue_on_warning: false
artifact_retention_days: 30
timezone_note: Los cron de GitHub Actions corren en UTC. Lima es UTC-5.
