...
¿Qué venta está firmada pero incompleta en caja?
...
`config/dashboard_params.yml#cobranza_avance`

## Parámetros actuales usados como contexto

```yaml
paid_threshold_pct: 0.95
include_overpayment: true
