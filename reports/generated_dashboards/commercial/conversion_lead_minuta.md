...
¿Qué fuentes generan ventas, no solo leads?
...
`config/dashboard_params.yml#lead_to_minuta`

## Parámetros actuales usados como contexto

```yaml
conversion_window_days: 90
attribution_model: last_touch_with_first_touch_context
