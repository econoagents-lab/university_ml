...
¿Qué separaciones convierten y cuáles quedan en riesgo?
...
`config/dashboard_params.yml#conversion_sep_minuta`

## Parámetros actuales usados como contexto

```yaml
conversion_window_days: 30
include_same_month: true
include_previous_pipeline: true
