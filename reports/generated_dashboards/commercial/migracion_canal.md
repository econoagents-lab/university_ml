...
¿Cuántas ventas entran por un canal y cierran por otro?
...
`config/dashboard_params.yml#channel_migration`

## Parámetros actuales usados como contexto

```yaml
migration_definition: canal_inicial != canal_cierre
show_migration_matrix: true
