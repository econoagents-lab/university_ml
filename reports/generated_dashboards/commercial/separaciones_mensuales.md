...
`config/business_rules.yml#separacion_valida`

## Parámetros actuales usados como contexto

```yaml
official_date: fecha_separacion
rule: proceso de separación válido y no duplicado
