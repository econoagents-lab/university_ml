# North Star Comercial

**Familia:** `executive`  
**Owner:** Gerencia Comercial  
**Audiencia:** C-level / Comercial  
**Prioridad:** professional  
**Estado:** cataloged

## Pregunta económica

¿La operación comercial mejora o se deteriora?
...
`config/metric_contracts.yml#north_star`

## Parámetros actuales usados como contexto

```yaml
metric: valor_esperado_en_riesgo_intervenido_y_convertido
owner: Gerencia Comercial
cadence: weekly
