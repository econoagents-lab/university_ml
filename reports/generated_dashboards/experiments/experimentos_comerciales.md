...
**Familia:** `experiments`  
**Owner:** Chief Economist / Data Science  
**Audiencia:** Gerencia  
...
`config/experiment_params.yml#riesgo_caida`

## Parámetros actuales usados como contexto

```yaml
control_group_share: 0.2
random_seed: 42
primary_outcome: caida_30d
secondary_outcome: firma_minuta_30d
