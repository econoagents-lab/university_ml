...
**Audiencia:** Gerencia Comercial / Asesores  
**Prioridad:** mvp  
**Estado:** cataloged

## Pregunta económica

¿Qué operaciones activas tienen mayor probabilidad de caer?
...
`config/model_params.yml#riesgo_caida`
...
horizon_days: 30
target: caida_30d
unit_of_analysis: codigo_proforma + codigo_unidad + fecha_snapshot
unit_focus: departamento
thresholds:
  p0: 0.7
  p1: 0.5
  p2: 0.35
