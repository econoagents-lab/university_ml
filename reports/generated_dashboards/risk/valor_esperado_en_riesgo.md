...
¿Cuánto valor económico está expuesto?
...
`config/dashboard_params.yml#value_at_risk`

## Parámetros actuales usados como contexto

```yaml
currency: PEN
formula: probabilidad_caida * precio_departamento
show_only_aggregated_public: true
