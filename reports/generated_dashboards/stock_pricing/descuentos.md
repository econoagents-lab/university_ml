...
**Owner:** Comercial / Finanzas  
**Audiencia:** Comercial / Finanzas  
**Prioridad:** professional  
**Estado:** cataloged

## Pregunta económica

¿Qué descuentos ayudan y cuáles erosionan margen?
...
`config/dashboard_params.yml#discounts`

## Parámetros actuales usados como contexto

```yaml
discount_warning_pct: 0.05
discount_critical_pct: 0.1
