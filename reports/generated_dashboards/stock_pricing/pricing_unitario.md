...
**Familia:** `stock_pricing`  
**Owner:** Producto / Chief Economist  
**Audiencia:** Producto / Gerencia  
**Prioridad:** professional  
**Estado:** cataloged

## Pregunta económica

¿Qué unidades están caras o baratas?
...
`config/dashboard_params.yml#pricing_unitario`
...
- m2
- piso
price_gap_warning_pct: 0.1
price_gap_critical_pct: 0.15
