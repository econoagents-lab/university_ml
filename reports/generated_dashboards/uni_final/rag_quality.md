...
**Familia:** `uni_final`  
**Owner:** RAG Owner  
**Audiencia:** UNI / Producto  
**Prioridad:** mvp  
**Estado:** cataloged

## Pregunta económica

¿El asistente responde con evidencia?
...
`config/alert_thresholds.yml#rag_quality`

## Parámetros actuales usados como contexto

```yaml
summary_path: reports/uni_final/RAGAS_LIKE_SUMMARY.md
faithfulness_proxy_mean_min: 0.75
answer_relevance_proxy_mean_min: 0.55
context_relevance_proxy_mean_min: 0.6
trap_refusal_rate_min: 1.0
