...
function Run-CommandLogged($StepName, $Command, $LogName, [switch]$Required) {
...
Write-Step "Machine Learning University v1.0.1 CRM Fresh Runner"
...
if ($ForceExtract) {
    ...
    Run-CommandLogged "Extract Redshift to Parquet" $ExtractCmd "extract_redshift.log" -Required | Out-Null
}
...
$Bitacora = Join-Path $RunDir "BITACORA_EJECUTIVA_V10_1_CRM_FRESH.md"

$Lines = @()
$Lines += "# Machine Learning University - Bitácora Ejecutiva v1.0.1 CRM Fresh"
$Lines += ""
